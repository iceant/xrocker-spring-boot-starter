...
import com.github.iceant.xrocker.spring.boot.starter.SpringRocker;
...
public class $ implements ApplicationContextAware {
    ...
    public static void setApplicationContextManually(ApplicationContext applicationContext){
        $.applicationContext = applicationContext;
    }
    ...
    public static BindableRockerModel template(String templatePath){
        ...
        return new SpringRocker(rockerBootstrap).template(templatePath);
    }

    public static BindableRockerModel template(String templatePath, Object ... arguments){
        RockerBootstrap rockerBootstrap = (RockerBootstrap) getBean(RockerBootstrap.class);
        if(rockerBootstrap==null) return null;
        return new SpringRocker(rockerBootstrap).template(templatePath, arguments);
    }
}
